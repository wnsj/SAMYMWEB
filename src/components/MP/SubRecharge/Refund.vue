        ...
        <div class="modal-body  pos_r">
            <div class="tab-pane fade in active martop" id="basic">
                <form action="">
                    ...
                    <div class="col-md-6 form-group clearfix">
                        <label for="cyname" class="col-md-4 control-label text-right nopad end-aline"
                               style="padding:0;line-height:34px;">退费课时</label><span class="sign-left">:</span>
                        <div class="col-md-7">
                            <input type="text" class="form-control" v-model="refund.consumCount"
                                   @change="receivableAction(refund.consumCount)">
                        </div>
                    </div>
                    <div class="col-md-6 form-group clearfix">
                        <label for="cyname" class="col-md-4 control-label text-right nopad end-aline"
                               style="padding:0;line-height:34px;">退费金额</label><span
                        class="sign-left">:</span>
                        <div class="col-md-7">
                    ...
                    <div class="col-md-6 form-group clearfix">
                        <label for="cyname" class="col-md-4 control-label text-right nopad end-aline"
                               style="padding:0;line-height:34px;">实退总额</label><span
                        class="sign-left">:</span>
                        <div class="col-md-7">
                    ...
                    <div class="col-md-6 form-group clearfix">
                        <label for="cyname" class="col-md-4 control-label text-right nopad end-aline"
                               style="padding:0;line-height:34px;">违约总额</label><span
                        class="sign-left">:</span>
                        <div class="col-md-7">
    ...
    export default {
        ...
        methods: {
            ...
            receivableAction(param) {
                if (this.selectObj != null) {
                    this.refund.money = this.selectObj.price * param
                }
            }
        }
