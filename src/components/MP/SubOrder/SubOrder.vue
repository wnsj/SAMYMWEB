		...
		<div class="modal-body  pos_r">
			<div class="tab-pane fade in active martop" id="basic">
				<form action="" class="clearfix">
					<div class="col-md-10 form-group clearfix">
					...
					<div class="form-group clearfix">
						<div class="col-md-12">
							<button type="button" class="btn btn-primary pull-right m_r_10" style="margin-right:1.5%;" data-toggle="modal" v-on:click="addOrder()">确认</button>
		...
		methods:{
			...
			initData(param,order) {
				if(param=='add'){
					...
					this.hospNum=this.order.hospNum
					this.$refs.dept.setDpart(this.order.deptId)
					this.$refs.ps.setObjId(this.order.patitypeid)
					this.$refs.mis.setObjId(this.order.mitypeid)
				}
			},
			//date formatting 
			dateAction(param){
