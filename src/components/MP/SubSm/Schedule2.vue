            ...
            <div class="tab-pane fade in active martop" id="basic">
                <form action="" class="clearfix">
                    ...
                    <div class="col-md-12 form-group clearfix jh-pr-0">
                        <el-calendar v-model="curDate" :disabled='true' ref="elCalendarRef">
                            <template slot="dateCell" slot-scope="{date, data}">
                                ...
                                <div v-if="data.type == 'current-month'">
                                    ...
                                    <div>
                                        <center><input type="checkbox" v-model="data.morning" :id="data.inputMon">上午</center>
                                    </div>
                                    <div>
                                        <center><input type="checkbox" v-model="data.afternoon" :id="data.inputAft">下午</center>
                                    </div>
                                </div>
                            </template>
                        </el-calendar>
...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            for (var i = 0; i < endDate.get('date'); i++) {
                var obj = {
                    empId: "",
                    morning: true,
                    afternoon: true,
                    ...
                    createDate: '',
                    schedulingDate: i == 0 ? startDate.format("YYYY-MM-DD") : startDate.add(1, 'days').format(
                        "YYYY-MM-DD")
                };
