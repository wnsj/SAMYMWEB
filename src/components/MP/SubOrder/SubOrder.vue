				...
				<form action="" class="clearfix">
					...
					<div class="col-md-12 form-group clearfix">
						...
						<div class="col-md-3 form-group clearfix btnBg" style="padding-left:0;padding-right:0;width:22%;margin-right:4%;">
							...
							<div class="col-md-4" style='line-height:34px;padding-right:0;'>
								<input type="checkbox" ref="ch22" v-model="order.time22" class="form-control" :disabled="orderCounselorOld.time22" v-on:change="setOrder(22,order.time22)">
							</div>
						</div>
						<div class="col-md-3 form-group clearfix btnBg" style="padding-left:0;padding-right:0;width:22%;margin-right:4%;">
							<label class="col-md-8 control-label text-right nopad" style="padding:0;line-height:34px;">{{timeArray[22]}}</label>
							<div class="col-md-4" style='line-height:34px;padding-right:0;'>
								<input type="checkbox" ref="ch23" v-model="order.time23" class="form-control" :disabled="orderCounselorOld.time23" v-on:cli="setOrder(23,order.time23)">
							</div>
						</div>
					</div>
