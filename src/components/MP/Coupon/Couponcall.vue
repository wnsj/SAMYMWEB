		...
		<div class="modal-body  pos_r jh-mh-sc1">
			...
			<div class="tab-pane fade in active martop">
				...
				<div class="col-md-6 form-group clearfix">
					...
					<div class="col-md-7  ">
						<input type="text" class="form-control" v-model="consume.serialNo" :disabled="true">
					</div>
				</div>
				<div class="col-md-6 form-group clearfix">
					<b>*</b>
					...
					<div class="col-md-7  ">
						<emp ref="emp" @employeeChange="empChange" disabled></emp>
					</div>
				</div>
				<div class="col-md-6 form-group clearfix">
					<b>*</b>
					...
					<div class="col-md-7  ">
						<select class="form-control" v-model="consume.isuse" disabled>
				...
				<div class="col-md-6 form-group clearfix shiyong">
					...
					<div class="col-md-7">
						<div class="xianzhi"><input class="xian" type="radio" name="radioGroup" @click="radioClick($event,item)" /><label class="xian1">无限制</label></div>
						<div class="xianzhi1"><input class="xian" type="radio" name="radioGroup" @click="radioClick($event,item)" /><label class="xian1">满</label></div>
						<div class="xianzhi2"><input type="text" placeholder="0" :disabled="true"><span>元可用</span></div>
					</div>
				</div>
			...
			<div class="tab-pane fade in active martop">
				...
				<div class="col-md-12 form-group clearfix">
					...
					<div class="col-md-8 shiyong shiyong1">
						<div class="xianzhi"><input class="xian" type="radio" :disabled="true" name="radioGroup" @click="radioClick($event,item)" /><label class="xian1">全体用户</label></div>
						<div class="xianzhi1"><input class="xian" type="radio" :disabled="true" name="radioGroup" @click="radioClick($event,item)" /><label class="xian1">新用户</label></div>
						<div class="xianzhi1"><input class="xian" type="radio" :disabled="true" name="radioGroup" @click="radioClick($event,item)" /><label class="xian1">指定用户</label></div>
						<div class="xianzhi3_1"><p style="cursor: pointer;" v-on:click="seles1" v-has="'SAMY:MP:Coupon:selectcall'">查看用户</p></div>
					</div>
				</div>
				<div class="col-md-12 form-group clearfix">
					<b>*</b>
					...
					<div class="col-md-8 shiyong shiyong1">
						<div class="xianzhi"><input class="xian" type="radio" :disabled="true" name="radioGroup" @click="radioClick($event,item)" /><label class="xian1">全品类</label></div>
				...
				<div class="col-md-6 form-group clearfix">
					...
					<div class="col-md-7 shiyong shiyong1">
						<div class="xianzhi6"><input type="text" placeholder="0" :disabled="true"><span>张</span></div>
					</div>
				</div>
				<div class="col-md-6 form-group clearfix"></div>
			</div>
			...
			<div class="col-md-12 form-group clearfix">
				<button type="button" class="btn btn-warning pull-center m_r_10 jh-mr-35" v-on:click="goOff()">返回</button>
			</div>
		</div>
...
<style scoped>
	...
	.shiyong .xianzhi2 input{width: 100%; outline: none;border:1px solid #DDDDDD;height: 25px;position: relative;}
	...
	.shiyong .xianzhi6 input{width: 100%; outline: none;border:1px solid #DDDDDD;height: 25px;position: relative;}
