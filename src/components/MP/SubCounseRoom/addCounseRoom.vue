		...
		<div class="modal-body  pos_r">
			<div class="tab-pane fade in active martop" id="basic">
				<form action="" class="clearfix">
					...
					<div class="col-md-6 form-group clearfix">
						<label class="col-md-3 control-label text-right nopad end-aline">咨询室类型</label><span class="sign-left">:</span>
						<div class="col-md-8">
							<select class="form-control" v-model="crType">
								<option value="1">普通</option>
								<option value="2">专用(未占用咨询室)</option>
							</select>
						</div>
					</div>
