...
<template>
    ...
    <div class="wraper">
		...
		<div class="subVisTree" id="subVisTree">
			<subTree ref='subTree' @certainAction='feedBack(8)'></subTree>
		</div>
        <div class="row row_edit">
            <div class="modal fade" id="memContent">
                <div class="modal-dialog">
                    <tm ref='tm' @closeCurrentPage='feedBack(7)'></tm>
                </div>
            </div>
        </div>
        <div class="row row_edit">
            <div class="modal fade" id="customContent">
                <div class="modal-dialog wd1000">
                    <custom ref='custom' @closeCurrentPage='feedBack(5)'></custom>
                </div>
            </div>
        </div>
        <div class="row row_edit">
            <div class="modal fade" id="refundContent">
                <div class="modal-dialog wd1000">
                    <refund ref='refund' @closeCurrentPage='feedBack(4)'></refund>
                </div>
            </div>
        </div>
        <div class="row row_edit">
            <div class="modal fade" id="rechargeContent">
                <div class="modal-dialog wd1000">
                    <recharge ref='recharge' @closeCurrentPage='feedBack(3)'></recharge>
                </div>
            </div>
        </div>
        <div class="row row_edit">
    ...
    export default {
        ...
        methods: {
            ...
            btnAction(index) {
                ...
                switch (index) {
                    case '1':
                        if (this.objectContent.isMem != 1) {
                            alert('非会员不能进行套餐课程的购买，若要购买，请转成会员进行购买')
                            return
                        }
