                ...
                <div class="col-md-12 col-lg-12">
                    <div class="table-responsive pre-scrollable" ref="tab1">
                        <table class="table table-bordered table-hover mb0" id="datatable">
                            ...
                            <tbody>
                            <tr v-for="(item,index) in royaltyList" :key="index" v-if="item.consumeType=='0'"
                                v-on:dblclick="selectRule('Royalty','3',item)">
                    ...
                    <div class="table-responsive pre-scrollable" ref="tab2">
                        <table class="table table-bordered table-hover mb0" id="datatable">
                            ...
                            <tr v-for="(item,index) in royaltyList" :key="index"
                                v-if="item.consumeType=='1' || item.consumeType=='2'"
                                v-on:dblclick="selectRule('SubVip','3',item)">
                                <td class="text-center">{{item.posName}}</td>
                ...
                <div class="col-md-12 col-lg-12 main-title" style="height:60px; overflow:hidden;">
                    ...
                    <div class="col-md-4 col-lg-4 pull-right">
                        <button type="button" class="btn btn-warning pos1"
                                v-on:click="selectRule('SubVipRefund','1','')" v-has="'SAMY:MP:Royalty:Add'">添加
                        </button>
                    </div>
                </div>
                <div class="col-md-12 col-lg-12">
                    <div class="table-responsive pre-scrollable" ref="tab3">
                        <table class="table table-bordered table-hover mb0" id="datatable">
                            ...
                            <tbody>
                            <tr v-for="(item,index) in royaltyList" :key="index" v-if="item.consumeType=='3'"
                                v-on:dblclick="selectRule('SubVipRefund','3',item)">
                                <td class="text-center">{{item.posName}}</td>
                                <td class="text-center">{{item.flowSmall}} 万</td>
        ...
        methods: {
            ...
            selectRule(module, operateType, item) {
                ...
                if (operateType == "1") {
                    ...
                    operateName = 'modify'
                    if (!this.has('SAMY:MP:Royalty:Update')){
                        alert("暂无权限!")
                        return
                    }
                }
