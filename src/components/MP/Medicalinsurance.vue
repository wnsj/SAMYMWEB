...
<template>
  <div>
          ...
          <table class="table table-bordered table-hover" id="datatable">
            ...
            <tbody>
              <tr v-for="(item,index) in objList" :key="index" v-on:dblclick="modifyObj(item)">
                ...
                <td class="text-center">{{item.mitypename}}</td>
    ...
    <div class="row row_edit">
      <div class="modal fade" id="medicalinsurancecontent">
        <div class="modal-dialog">

          <MIC ref='mic' @addObj='feedBack'></MIC>
...
<script>
  import MIC from '../MP/MI/MedicalInsuranceContent.vue'
  export default {
    components: {
      MIC,
    },
    ...
    methods: {
      ...
      addObj() {
        ...
        $("#medicalinsurancecontent").modal('show')
      },
      ...
      feedBack() {
        this.checkObj()
        $("#medicalinsurancecontent").modal('hide')
      },
