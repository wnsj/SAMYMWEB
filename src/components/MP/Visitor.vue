...
<template>
    ...
    <div class="wraper">
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-2 col-lg-12" style="margin-bottom: 10px;">
                <button type="button" class="btn btn-default pull-left" style="margin-right:1.5%;width: 100px;"
                        v-on:click="btnAction('5')">退 费
                </button>
                <button type="button" class="btn btn-success pull-left" style="margin-right:1.5%;width: 100px;"
                        v-on:click="btnAction('4')">预 约
                </button>
                <button type="button" class="btn btn-success pull-left" style="margin-right:1.5%;width: 100px;"
                        v-on:click="btnAction('3')">定 金
                </button>
                <button type="button" class="btn btn-success pull-left" style="margin-right:1.5%;width: 100px;"
                        v-on:click="btnAction('2')">消 费
                </button>
                <button type="button" class="btn btn-success pull-left" style="margin-right:1.5%;width: 100px;"
                        v-on:click="btnAction('1')">购 买
                </button>
            </div>
        ...
        <div class="row" style="margin-top: 15px;">
            <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                <div class="col-md-5 col-lg-5 text-right" style="padding: 0; line-height: 34px;">
                    <p class="end-aline col-md-11 col-lg-11" style="padding-right:5px; padding-left:20px;">访问类型</p><span
                    class="sign-left">:</span>
                </div>
                <div class="col-md-7 col-lg-7">
            ...
            <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                <div class="col-md-5 col-lg-5 text-right" style="padding: 0; line-height: 34px;">
                    <p class="end-aline col-md-11 col-lg-11" style="padding-right:5px; padding-left:20px;">接待人</p><span
                    class="sign-left">:</span>
                </div>
                <div class="col-md-7 col-lg-7">
            ...
            <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                <div class="col-md-5 col-lg-5 text-right" style="padding: 0; line-height: 34px;">
                    <p class="end-aline col-md-11 col-lg-11" style="padding-right:5px; padding-left:20px;">转会员</p><span
                    class="sign-left">:</span>
                </div>
                <div class="col-md-7 col-lg-7">
        ...
        <div class="row" style="margin-top: 15px;padding-bottom:1.5%;">
            ...
            <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                <div class="col-md-5 col-lg-5 text-right" style="padding: 0; line-height: 34px;">
                    <p class="end-aline col-md-11 col-lg-11" style="padding-right:5px; padding-left:20px;">生日</p><span
                    class="sign-left">:</span>
                </div>
                <div class="col-md-7 col-lg-7">
                    ...
                    <table class="table table-bordered table-hover" id="datatable" style="width: 2400px;">
                        ...
                        <tr v-for="(item,index) in visitorList" :key="index" v-on:dblclick="selectRule('3',item)">
                            <td class="text-center" v-has="'SAMY:MP:Visitor:Update'">
                                ...
                                <input type="radio" style="border-radius:5px;" name="复选框" :value="index"
