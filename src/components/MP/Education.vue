    ...
    <div class="wraper">
        ...
        <div class="row jh-mp-1">
            ...
            <button type="button" class="btn btn-warning pull-right m_r_10 jh-mr-30"
                    data-toggle="modal"
                    v-on:click="selectRule('1')" v-has="'SAMY:MP:Education:Add'">添加
            </button>
            ...
            <div class="col-md-12 col-lg-12">
                <div class="table-responsive pre-scrollable">
                    <table class="table table-bordered table-hover" id="datatable">
                        ...
                        <tr>
                            <th class="text-center">学历ID</th>
                            <th class="text-center">学历名称</th>
                        ...
                        <tr v-for="(item,index) in objList" :key="index" v-on:dblclick="selectRule('3',item)">
                            <td class="text-center">{{item.eduId}}</td>
                            <td class="text-center">{{item.eduName}}</td>
...
<script>
    ...
    import SubEducation from '../MP/SubEducation/SubEducation.vue'
    import {
        init
...
//                         return
//                     }
                    this.$refs.subEducation.initData('modify', item)
                    $("#subEducationContent").modal('show')
                }
            },
