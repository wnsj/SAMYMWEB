<template>
	<div class="wraper">
				...
				<el-form label-position="right" label-width="100px" :inline="false" size="small" :model="param">
					<el-row style="margin-top: 2%">
						<el-col :span="12" class="jh-pr-28">
							<el-form-item label="初访时间:">
								<el-date-picker v-model="param.firstVisitStartTime" :picker-options="pickerOptions0" @change="initPage" type="date"
								 placeholder="开始时间">
								</el-date-picker>
								<span> - </span>
								<el-date-picker v-model="param.firstVisitEndTime" :picker-options="pickerOptions1" type="date" @change="initPage"
								 placeholder="结束时间">
								</el-date-picker>
							</el-form-item>
						</el-col>
					...
					<el-row>
						<el-col :span="12" class="jh-pr-28">
							<el-form-item label="到访时间:">
								<el-date-picker v-model="param.secondVisitStartTime" :picker-options="pickerOptions0" @change="initPage" type="date"
								 placeholder="开始时间">
								</el-date-picker>
								<span> - </span>
								<el-date-picker v-model="param.secondVisitEndTime" :picker-options="pickerOptions1" @change="initPage" type="date"
								 placeholder="结束时间">
								</el-date-picker>
							</el-form-item>
						</el-col>
					...
					<el-row>
						<el-col :span="6" :offset="15">
							<el-button type="primary" size="small" style="width: 85px" @click="getAllConByCondition" class="jh-fr">查询
							</el-button>
						</el-col>
						<el-col :span="2">
							<el-button type="primary" size="small" style="width: 85px" @click="exportTableToExcel('visitorDe','访客跟踪明细表')"
							 class="jh-fr">导出
							</el-button>
						</el-col>
					</el-row>
		...
		<div>
			<el-table :data="tableData" :cell-style="cellStyle" :header-cell-style="headerStyle" max-height="530" id="visitorDe"
			 style="margin-top: 20px" border>
				<el-table-column align="center" prop="firstTime" label="初访时间" min-width="100">
				</el-table-column>
				<el-table-column align="center" prop="receiveTime" label="到访时间" min-width="100">
				</el-table-column>
				<el-table-column align="center" prop="visitType" label="访问类型" min-width="90">
				</el-table-column>
				<el-table-column align="center" prop="continState" label="续流状态" min-width="90">
				</el-table-column>
				<el-table-column align="center" prop="storeName" label="门店" min-width="100">
				</el-table-column>
				<el-table-column align="center" prop="memName" label="咨客姓名" min-width="100">
				</el-table-column>
				<el-table-column align="center" prop="diseaseType" label="咨询方向" min-width="100">
				</el-table-column>
				<el-table-column align="center" prop="diseaseProblem" label="咨询问题" min-width="100">
				</el-table-column>
				<el-table-column align="center" prop="counselorName" label="咨询师" min-width="95">
				</el-table-column>
				<el-table-column align="center" prop="empName" label="顾问" min-width="95">
				</el-table-column>
				<el-table-column align="center" prop="phone" label="联系方式" min-width="100">
				</el-table-column>
				<el-table-column align="center" prop="proName" label="产品" min-width="100">
				</el-table-column>
				<el-table-column align="center" prop="isfirst" label="客户判定" min-width="100">
				</el-table-column>
				<el-table-column align="center" prop="totalCount" label="时长" min-width="100">
				</el-table-column>
				<el-table-column align="center" prop="realCross" label="金额" min-width="100">
				</el-table-column>
				<el-table-column align="center" prop="reason" label="原因" show-overflow-tooltip min-width="100">
				</el-table-column>
				<el-table-column align="center" prop="remark" show-overflow-tooltip label="跟进情况" min-width="100">
				</el-table-column>
				<el-table-column align="center" prop="followUpPerson" label="跟进人" min-width="100">
				</el-table-column>
				<el-table-column align="center" prop="title" label="类型" min-width="95">
				</el-table-column>
			</el-table>
