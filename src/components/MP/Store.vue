        ...
        <div class="row" style="margin-top: 40px;padding-bottom:1.5%;">
            <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                <div class="col-xs-5 col-sm-5 col-md-5 col-lg-5" style="padding: 0; line-height: 34px;">
                    <p class="end-aline col-md-11 col-lg-11" style="padding-right:5px; padding-left:20px;">门店名</p><span
                ...
                <div class="table-responsive pre-scrollable">
                    <table class="table table-bordered table-hover" id="datatable">
                        ...
                        <tr>
                            ...
                            <th class="text-center" v-has="'SAMY:MP:Store:Update'">修改</th>
                        </tr>
                        </thead>
                        <tbody>
                        <tr v-for="(item,index) in storeList" :key="index" v-on:dblclick="selectRule('3',item)">
                            ...
                            <td class="text-center" v-has="'SAMY:MP:Store:Update'">
