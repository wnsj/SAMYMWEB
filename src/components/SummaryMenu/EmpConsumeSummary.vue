        ...
        <div class="">
			<el-table ref="productTable" :data="objList" style="width: 100%" show-summary>
				...
				<el-table-column label="总金额" width="100" align="center">
					<template slot-scope="scope"><p>{{parseFloat(scope.row.piSecondVisit)+parseFloat(scope.row.piFirstVisit)+parseFloat(scope.row.conFirstVisit)+parseFloat(scope.row.conSecondVisit)}}</p></template>
				</el-table-column>
				<el-table-column label="流水收入金额" width="100" align="center">
					<template slot-scope="scope"><p>{{scope.row.conFirstVisit+scope.row.conSecondVisit}}</p></template>
				</el-table-column>
				<el-table-column label="首签金额" width="100" align="center">
					<template slot-scope="scope"><p>{{scope.row.piInitialSign}}</p></template>
				</el-table-column>
				<el-table-column label="首签率￥" width="100" align="center">
					<template slot-scope="scope"><p>{{scope.row.posName}}</p></template>
				</el-table-column>
				<el-table-column label="复签金额" width="100" align="center">
					<template slot-scope="scope"><p>{{scope.row.piRepeatSign}}</p></template>
				</el-table-column>
				<el-table-column label="复签率￥" width="100" align="center">
					<template slot-scope="scope"><p>{{scope.row.posName}}</p></template>
				</el-table-column>
				<el-table-column label="续签金额" width="100" align="center">
					<template slot-scope="scope"><p>{{scope.row.posName}}</p></template>
				</el-table-column>
				<el-table-column label="续签率￥" width="100" align="center">
					<template slot-scope="scope"><p>{{scope.row.posName}}</p></template>
				</el-table-column>
				<el-table-column label="签约总金额" width="100" align="center">
					<template slot-scope="scope"><p>{{scope.row.posName}}</p></template>
				</el-table-column>
				<el-table-column label="总营业额" width="100" align="center">
					<template slot-scope="scope"><p>{{scope.row.posName}}</p></template>
				</el-table-column>
				<el-table-column label="签约率￥" width="100" align="center">
					<template slot-scope="scope"><p>{{scope.row.posName}}</p></template>
				</el-table-column>
				<el-table-column label="初访人均" width="100" align="center">
					<template slot-scope="scope"><p>{{scope.row.posName}}</p></template>
				</el-table-column>
			</el-table>
        </div>
