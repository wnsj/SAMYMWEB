...
//获取账户所有信息
constant.getAccData = function getAccData() {
    var jsonString = Cookies.get("accountData");
    //未登录
    if (this.isBlank(jsonString)) return false;
...
//获取员工id
constant.getEmpId = function getEmpId() {
    var empData = constant.getEmpData()
    if(empData == false) return false;
