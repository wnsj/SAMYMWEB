...
<template>
	<div class="modal-content">
		<div class="modal-header">
			...
			<h4 id="myModalLabel" class="modal-title">{{title}}患者</h4>
		</div>
		<div class="modal-body  pos_r">
			<div class="tab-pane fade in active martop" id="basic">
				<form action="">
					<div class="col-md-6 form-group clearfix">
						<label for="cyname" class="col-md-4 control-label text-right nopad" style="padding:0;line-height:34px;">住院号：</label>
						<div class="col-md-8">
							<input type="text" class="form-control" :disabled="isModify" v-model="hospNum" placeholder="" v-on:change="conditionCheck(hospNum)">
							<div style="position:absolute; top:50%; margin-top:-9px; right:-5%;">
								<span class="glyphicon glyphicon-ok label-success img-circle show" style="color:#FFF; padding:2px;"  aria-hidden="true"></span>
								<span class="glyphicon glyphicon-remove label-danger img-circle hidden" style="color:#FFF; padding:2px;" aria-hidden="true"></span>
							</div>
						</div>
					</div>
					<div class="col-md-6 form-group clearfix">
					...
					<div class="col-md-6 form-group clearfix">
						<label for="gh" class="col-md-4 control-label text-right nopad" style="padding:0;line-height:34px;">科室：</label>
						<div class="col-md-8">
							<department ref="dept" @departChange='departChange'></department>
						</div>
					</div>
					<div class="col-md-6 form-group clearfix">
						<label for="gh" class="col-md-4 control-label text-right nopad" style="padding:0;line-height:34px;">患者类型：</label>
						<div class="col-md-8">
							<PS ref="ps" @objChange='psChange'></PS>
						</div>
					</div>
					<div class="col-md-6 form-group clearfix">
						<label for="gh" class="col-md-4 control-label text-right nopad" style="padding:0;line-height:34px;">医保类型：</label>
						<div class="col-md-8">
							<MIS ref="mis" @objChange='misChange'></MIS>
						</div>
					</div>
					<div class="col-md-6 form-group clearfix">
						<label for="erpzh" class="col-md-4 control-label text-right nopad" style="padding:0;line-height:34px;">是否在院：</label>
						<div class="col-md-8">
					...
					<div class="col-md-6 form-group clearfix">
						<label class="col-md-4 control-label text-right nopad" style="padding:0;line-height:34px;">入院日期：</label>
						<dPicker class="col-md-8" style="width:65%;" v-model="patient.hospTime" v-on:change="dateAction('1')"></dPicker>
					</div>
					<div class="col-md-6 form-group clearfix">
						<label class="col-md-4 control-label text-right nopad" style="padding:0;line-height:34px;">出院日期：</label>
						<dPicker class="col-md-8" style="width:65%;" v-model="patient.outHosp" v-on:change="dateAction('2')"></dPicker>
					</div>
